...
class com_jemInstallerScript
{
    ...
    private function deleteObsoleteFiles()
    {
        $files = array(
			...
			'/plugins/plg_content_jem/language/en-GB/en-GB.plg_content_jem.ini',
			'/plugins/plg_content_jem/language/en-GB/en-GB.plg_content_jem.sys.ini',
			'/plugins/plg_content_jemlistevents/language/en-GB/en-GB.plg_content_jemlistevents.ini',
			'/plugins/plg_finder_jem/language/en-GB/en-GB.plg_finder_jem.ini',
			'/plugins/plg_finder_jem/language/en-GB/en-GB.plg_finder_jem.sys.ini',
			'/plugins/plg_jem_comments/language/en-GB/en-GB.plg_jem_comments.ini',
			'/plugins/plg_jem_comments/language/en-GB/en-GB.plg_jem_comments.sys.ini',
			'/plugins/plg_jem_mailer/language/en-GB/en-GB.plg_jem_mailer.ini',
