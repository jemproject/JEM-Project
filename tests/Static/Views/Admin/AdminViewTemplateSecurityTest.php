...
final class AdminViewTemplateSecurityTest extends TestCase
{
    /**
     * @return iterable<string, array{string}>
     */
    public static function adminViewPhpProvider(): iterable
    {
        yield from self::phpFilesIn(JEM_TEST_ROOT . '/admin/views');
    }

    #[DataProvider('adminViewPhpProvider')]
    public function testAdminViewPhpFilesBlockDirectAccess(string $path): void
    {
