...
final class AdminXmlTest extends TestCase
{
    /**
     * @return iterable<string, array{string}>
     */
    public static function adminXmlProvider(): iterable
    {
        yield from self::xmlFilesIn(JEM_TEST_ROOT . '/admin/models/forms');
        yield from self::xmlFilesIn(JEM_TEST_ROOT . '/admin/views');
    }

    #[DataProvider('adminXmlProvider')]
    public function testAdminXmlIsWellFormed(string $path): void
    {
