...
final class SiteXmlTest extends TestCase
{
    /**
     * @return iterable<string, array{string}>
     */
    public static function siteXmlProvider(): iterable
    {
        yield from self::xmlFilesIn(JEM_TEST_ROOT . '/site/models/forms');
        yield from self::xmlFilesIn(JEM_TEST_ROOT . '/site/views');
    }

    #[DataProvider('siteXmlProvider')]
    public function testSiteXmlIsWellFormed(string $path): void
    {
