                                ...
                                <div class="teaser-jem"><div>
                                        <?php if ($item->showimageevent) : ?>
                                            <?php if (strpos($item->eventimage, '/media/com_jem/images/blank.webp') === false) : ?>
                                                ...
                                                ); ?>" data-title="<?php echo Text::_('COM_JEM_EVENT') . ': ' . $item->fulltitle; ?>"><img class="float_right image-preview" style="<?php echo $eventImageStyle; ?>" src="<?php echo $item->eventimage; ?>" width="<?php echo (int) $item->eventimagewidth; ?>" height="<?php echo (int) $item->eventimageheight; ?>" alt="<?php echo $item->title; ?>" /></a>
