...
//window.addEvent('domready', function() {
  ...
  $("jform_recurrence_type").addEvent('change', output_recurrencescript); // additional event handler
...
function output_recurrencescript() {
	var $select_value = $("jform_recurrence_type").value;	// the value of the select list
