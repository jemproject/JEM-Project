        ...
        <div class="table">
            <table class="table table-striped itemList" id="eventList">
                ...
                <tr>
                    ...
                    <th class="center jem-list-featured"><?php echo HTMLHelper::_('searchtools.sort', 'JFEATURED', 'a.featured', $listDirn, $listOrder, null, 'desc'); ?></th>
                    <th class="center nowrap jem-list-status"><?php echo Text::_('JSTATUS'); ?></th>
                    <th class="nowrap"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_DATE', 'a.dates', $listDirn, $listOrder); ?></th>
                    <th><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_STARTTIME_SHORT', 'a.times', $listDirn, $listOrder); ?></th>
                    <th class="nowrap"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_EVENT_TITLE', 'a.title', $listDirn, $listOrder); ?></th>
                    <th class="nowrap center"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_EVENT_FIELD_EVENT_STATUS_LABEL', 'a.event_status', $listDirn, $listOrder); ?></th>
                    <th class="nowrap center"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_EVENT_FIELD_TICKET_AVAILABILITY_LABEL', 'a.ticket_availability', $listDirn, $listOrder); ?></th>
                    <th class="nowrap"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_TYPE', 'jt.name', $listDirn, $listOrder); ?></th>
                    <th><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_VENUE', 'loc.venue', $listDirn, $listOrder); ?></th>
                    ...
                    <th style="width: 1%" class="center nowrap"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_ARTICLE_ID', 'a.article_id', $listDirn, $listOrder); ?></th>
                    <th style="width: 9%" class="center"><?php echo HTMLHelper::_('searchtools.sort', 'JGRID_HEADING_ACCESS', 'a.access', $listDirn, $listOrder); ?></th>
                    <th class="nowrap" data-jem-default-hidden><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_AUTHOR', 'u.name', $listDirn, $listOrder); ?></th>
                    <th class="center nowrap"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_HITS', 'a.hits', $listDirn, $listOrder); ?></th>
                    <th class="center nowrap"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_LAST_VISIT', 'a.last_visit', $listDirn, $listOrder); ?></th>
                    <th class="center nowrap"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_DATE_CREATED', 'a.created', $listDirn, $listOrder); ?></th>
                    <th style="width: 1%" class="center nowrap"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_ID', 'a.id', $listDirn, $listOrder); ?></th>
                </tr>
                </thead>
