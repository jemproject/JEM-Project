        ...
        <table class="table table-striped itemList<?php echo $hideOrderNumbers ? ' jem-hide-order-numbers' : ''; ?>" id="categoryList">
            ...
            <tr>
                ...
                <th class="center jem-list-order-heading">
                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_TYPE_FIELD_ORDER', 'a.lft', $listDirn, $listOrder); ?>
                </th>
                <th class="center jem-list-status">
                    <?php echo HTMLHelper::_('searchtools.sort', 'JSTATUS', 'a.published', $listDirn, $listOrder); ?>
                </th>
                <th>
                    <?php echo HTMLHelper::_('searchtools.sort', 'JGLOBAL_TITLE', 'a.catname', $listDirn, $listOrder); ?>
                </th>
                <th style="width:5%" class="center" nowrap="nowrap">
                    <?php echo Text::_('COM_JEM_COLOR'); ?>
                </th>
                <th style="width:15%"><?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_GROUP', 'gr.name', $listDirn, $listOrder); ?></th>
                <th style="width:12%" class="center">
                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_CATEGORY_FIELD_ARTICLE_CATEGORY_LABEL', 'a.article_category_id', $listDirn, $listOrder); ?>
                </th>
                <th style="width:10%" class="center">
                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_CATEGORY_FIELD_ARTICLE_MODE_LABEL', 'a.article_create_mode', $listDirn, $listOrder); ?>
                </th>
                ...
                <th>
                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_AUTHOR', 'ua.name', $listDirn, $listOrder); ?>
                </th>
                <th class="center nowrap">
                    <?php echo HTMLHelper::_('searchtools.sort', 'COM_JEM_DATE_CREATED', 'a.created_time', $listDirn, $listOrder); ?>
                </th>
