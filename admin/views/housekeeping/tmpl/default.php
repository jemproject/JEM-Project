                    ...
                    <td style="width: 60px;">
                        <div class="linkicon">
                            <a href="index.php?option=com_jem&amp;task=housekeeping.cleaneventimg&amp;<?php echo Session::getFormToken(); ?>=1">
                                <?php echo HTMLHelper::_('image', 'com_jem/icon-48-cleaneventimg.webp', Text::_('COM_JEM_HOUSEKEEPING_EVENT_IMG'), NULL, true); ?>
                            </a>
                        </div>
                    </td>
                    <td>
                    ...
                    <td style="width: 60px;">
                        <div class="linkicon">
                            <a href="index.php?option=com_jem&amp;task=housekeeping.cleanvenueimg&amp;<?php echo Session::getFormToken(); ?>=1">
                                <?php echo HTMLHelper::_('image', 'com_jem/icon-48-cleanvenueimg.webp', Text::_('COM_JEM_HOUSEKEEPING_VENUE_IMG'), NULL, true); ?>
                            </a>
                        </div>
                    </td>
                    <td>
                    ...
                    <td style="width: 60px;">
                        <div class="linkicon">
                            <a href="index.php?option=com_jem&amp;task=housekeeping.cleancategoryimg&amp;<?php echo Session::getFormToken(); ?>=1">
                                <?php echo HTMLHelper::_('image', 'com_jem/icon-48-cleancategoryimg.webp', Text::_('COM_JEM_HOUSEKEEPING_CATEGORY_IMG'), NULL, true); ?>
                            </a>
                        </div>
                    </td>
                    <td>
                    ...
                    <td style="width: 60px;">
                        <div class="linkicon">
                            <a href="index.php?option=com_jem&amp;task=housekeeping.triggerarchive&amp;<?php echo Session::getFormToken(); ?>=1">
                                <?php echo HTMLHelper::_('image', 'com_jem/icon-48-archive.webp', Text::_('COM_JEM_HOUSEKEEPING_TRIGGER_AUTOARCHIVE'), NULL, true); ?>
                            </a>
                        </div>
                    </td>
                    <td>
                    ...
                    <td style="width: 60px;">
                        <div class="linkicon">
                            <a href="index.php?option=com_jem&amp;task=housekeeping.cleanupCatsEventRelations&amp;<?php echo Session::getFormToken(); ?>=1">
                                <?php echo HTMLHelper::_('image', 'com_jem/icon-48-cleancategoryimg.webp', Text::_('COM_JEM_HOUSEKEEPING_CATSEVENT_RELS'), NULL, true); ?>
                            </a>
                        </div>
                    </td>
                    <td>
                    ...
                    <td style="width: 60px;">
                        <div class="linkicon">
                            <a href="index.php?option=com_jem&amp;task=housekeeping.truncateAllData&amp;<?php echo Session::getFormToken(); ?>=1" onclick="return confirm('<?php echo Text::_('COM_JEM_HOUSEKEEPING_TRUNCATE_ALL_DATA_CONFIRM'); ?>');">
                                <?php echo HTMLHelper::_('image', 'com_jem/icon-48-truncatealldata.webp', Text::_('COM_JEM_HOUSEKEEPING_TRUNCATE_ALL_DATA'), NULL, true); ?>
                            </a>
                        </div>
                    </td>
                    <td>
