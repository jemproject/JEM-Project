        ...
        <form action="index.php" method="post" name="adminForm" enctype="multipart/form-data" id="adminForm">
            ...
            <div class="col-md-6">
                <fieldset class="adminform">
                    ...
                    <a onclick="return showblock(this);" style="cursor: hand; cursor: pointer; color:blue;"> fields list for venue</a><div style="display: none;"><div style="background-color:silver;border:1px solid #808080"><?php echo implode(", ",$this->venuefields); ?></div></div><br />
            ...
            <div class="col-md-6">
                <fieldset class="adminform">
                    ...
                    <?php echo Text::_("COM_JEM_IMPORT_POSSIBLECOLUMNS");?>
                    <a onclick="return showblock(this);" style="cursor: hand; cursor: pointer; color:blue;"> fields list for category</a><div style="display: none;"><div style="background-color:silver;border:1px solid #808080"><?php echo implode(", ",$this->catfields); ?></div></div><br />
            ...
            <div class="col-md-6">
                <fieldset class="adminform">
                    ...
                    <?php echo Text::_("COM_JEM_IMPORT_POSSIBLECOLUMNS");?>
                    <a onclick="return showblock(this);" style="cursor: hand; cursor: pointer; color:blue;"> fields list for event</a><div style="display: none;"><div style="background-color:silver;border:1px solid #808080"><?php echo implode(", ",$this->eventfields) . ',categories'; ?></div></div><br />
            ...
            <div class="col-md-6">
                <fieldset class="adminform">
                    ...
                    <?php echo Text::_("COM_JEM_IMPORT_POSSIBLECOLUMNS");?>
                    <a onclick="return showblock(this);" style="cursor: hand; cursor: pointer; color:blue;"> fields list for cat_events</a><div style="display: none;"><div style="background-color:silver;border:1px solid #808080"><?php echo implode(", ",$this->cateventsfields); ?></div></div><br />
