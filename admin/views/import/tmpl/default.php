        ...
        <form action="index.php" method="post" name="adminForm" enctype="multipart/form-data" id="adminForm">
            ...
            <div>
                <fieldset class="adminform">
                    ...
                    <a onclick="return showblock(this);" style="cursor: pointer; color:blue;"> <?php echo Text::_("COM_JEM_IMPORT_DB_VENUE_FIELDS");?></a><div style="display: none;"><div style="background-color:silver;border:1px solid #808080"><?php echo implode(", ",$this->venuefields); ?></div></div><br />
            ...
            <div>
                <fieldset class="adminform">
                    ...
                    <?php echo Text::_("COM_JEM_IMPORT_POSSIBLECOLUMNS");?>
                    <a onclick="return showblock(this);" style="cursor: pointer; color:blue;"> <?php echo Text::_("COM_JEM_IMPORT_DB_CATEGORY_FIELDS");?></a><div style="display: none;"><div style="background-color:silver;border:1px solid #808080"><?php echo implode(", ",$this->catfields); ?></div></div><br />
            ...
            <div>
                <fieldset class="adminform">
                    ...
                    <?php echo Text::_("COM_JEM_IMPORT_POSSIBLECOLUMNS");?>
                    <a onclick="return showblock(this);" style="cursor: pointer; color:blue;"> <?php echo Text::_("COM_JEM_IMPORT_DB_EVENT_FIELDS");?></a><div style="display: none;"><div style="background-color:silver;border:1px solid #808080"><?php echo implode(", ",$this->eventfields) . ',categories'; ?></div></div><br />
            ...
            <div>
                <fieldset class="adminform">
                    ...
                    <?php echo Text::_("COM_JEM_IMPORT_POSSIBLECOLUMNS");?>
                    <a onclick="return showblock(this);" style="cursor: pointer; color:blue;"> <?php echo Text::_("COM_JEM_IMPORT_DB_CATEVENT_FIELDS");?></a><div style="display: none;"><div style="background-color:silver;border:1px solid #808080"><?php echo implode(", ",$this->cateventsfields); ?></div></div><br />
