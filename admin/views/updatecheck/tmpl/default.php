        ...
        <?php if ($this->updatedata->failed == 0) : ?>
            <div class="update-info">
                ...
                if ($this->updatedata->current == 0 ) {
                    echo HTMLHelper::_('image', 'com_jem/icon-48-latest-version.webp', NULL, NULL, true);
                } elseif( $this->updatedata->current == -1 ) {
                    echo HTMLHelper::_('image', 'com_jem/icon-48-update.webp', NULL, NULL, true);
                } else {
                    echo HTMLHelper::_('image', 'com_jem/icon-48-unknown-version.webp', NULL, NULL, true);
                }
                ?>
                <?php
                if ($this->updatedata->current == 0) {
