 ...
 *
 */
class JFormFieldImageselectcategory extends JFormFieldList
{
	...
	public function getInput()
	{
		...
		$script[] = '		document.getElementById(\'imagelib\').src = \'../images/jem/categories/\' + image';
		...
		$html[] = "<input style=\"background: #ffffff;\" type=\"text\" id=\"a_imagename\" value=\"$this->value\" disabled=\"disabled\" onchange=\"javascript:if (document.forms[0].a_imagename.value!='') {document.imagelib.src='../images/jem/categories/' + document.forms[0].a_imagename.value} else {document.imagelib.src='../media/system/images/blank.png'}\"; />";
		$html[] = "</div>";
		...
		$html [] = "jsimg='../images/jem/categories/' + imname;";
