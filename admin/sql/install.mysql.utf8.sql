...
('pdf_imageheight', '40'),
('pdf_imagewidth', '40'),
('pdf_enabled_views', 'annualcalendar,attendeeregistrations,calendar,category,day,event,eventslist,eventsmap,myattendances,specialdays,typeevents,venue,venueslist,venuesmap,weekcal'),
('pdf_paper_size', 'A4'),
('pdf_orientation', 'L'),
...
('csv_delimiter', '"'),
('csv_bom', '1'),
('globalattribs', '{"loglevel":"2","actionlog_enabled":"0","event_show_online_meeting":"1","event_online_meeting_ics":"1","event_online_meeting_ics_description":"1","event_online_meeting_default_label":"","event_details_layout":"details","event_venue_layout":"details","event_show_publish_state":"0","calendar_special_days_enabled":"1","calendar_special_day_types":"Weekend | #d1d5db | 0\\nPublic holiday | #e5e7eb | 0"}'),
