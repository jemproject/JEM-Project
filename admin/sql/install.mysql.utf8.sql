CREATE TABLE IF NOT EXISTS `#__jem_events` (
    ...
    `recurrence_first_id` int NOT NULL DEFAULT '0',
    `recurrence_number` int NOT NULL DEFAULT '0',
    `recurrence_type` int NOT NULL DEFAULT '0',
    `recurrence_counter` int NOT NULL DEFAULT '0',
