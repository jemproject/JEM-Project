...
('showcat', '1'),
('catfrowidth', '15%'),
('image_filetypes', 'jpg,gif.webp,webp'),
('sizelimit', '100'),
('imagehight', '100'),
('imagewidth', '100'),
('gddisabled', '1'),
...
('attachments_types', 'txt,pdf,jpg,jpeg,gif.webp,webp,zip,tar.gz'),
...
('ical_max_items', '100'),
('defaultCountry', ''),
('flagicons_path', 'media/com_jem/images/flags/w20-webp/'),
('csv_separator', ';'),
('csv_delimiter', '"'),
('csv_bom', '1'),
('globalattribs', ''),
...
(172, 'OC', 'PG', .webp', 598, 'Papua New Guinea'),
