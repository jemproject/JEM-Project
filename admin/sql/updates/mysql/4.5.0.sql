...
-- new values
CREATE TABLE IF NOT EXISTS `#__jem_types` (`id` INT NOT NULL AUTO_INCREMENT,`name` VARCHAR(100) NOT NULL,`entity` TINYINT(1) NOT NULL DEFAULT 1 COMMENT '1=Event, 2=Category, 3=Venue, 4=Day',`alias` VARCHAR(100) NOT NULL DEFAULT '',`description` TEXT DEFAULT NULL,`base_language` CHAR(7) NOT NULL DEFAULT '',`translation_languages` VARCHAR(255) DEFAULT NULL,`translations` MEDIUMTEXT DEFAULT NULL,`icon` VARCHAR(255) DEFAULT NULL,`color` VARCHAR(7) DEFAULT NULL,`published` TINYINT(1) NOT NULL DEFAULT 1,`ordering` INT(11) NOT NULL DEFAULT 0,`access` INT(10) UNSIGNED NOT NULL DEFAULT 1,`language` CHAR(7) NOT NULL DEFAULT '*',`checked_out` INT(11) UNSIGNED NULL DEFAULT NULL,`checked_out_time` DATETIME NULL DEFAULT NULL,`created` DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,`created_by` INT(11) UNSIGNED NOT NULL DEFAULT 0,`modified` DATETIME NULL DEFAULT NULL,`modified_by` INT(11) UNSIGNED NOT NULL DEFAULT 0,`attribs` TEXT DEFAULT NULL,PRIMARY KEY (`id`),KEY `idx_entity` (`entity`),KEY `idx_published` (`published`),KEY `idx_access` (`access`),KEY `idx_checkout` (`checked_out`));
...
CREATE TABLE IF NOT EXISTS `#__jem_links` (`id` INT(11) NOT NULL AUTO_INCREMENT,`event_id` INT(11) NOT NULL,`type` VARCHAR(50) NOT NULL,`title` VARCHAR(255) NOT NULL,`description` VARCHAR(255)  NULL,`url` TEXT NOT NULL,`params` TEXT DEFAULT NULL,`ordering` INT(11) DEFAULT 0,`state` TINYINT(1) DEFAULT 1,`created` DATETIME DEFAULT CURRENT_TIMESTAMP,`created_by` INT(11) NOT NULL,`modified` DATETIME DEFAULT NULL,`modified_by` INT(11) DEFAULT NULL,PRIMARY KEY (`id`),INDEX `idx_event_id` (`event_id`),INDEX `idx_state` (`state`)) ENGINE=InnoDB;
CREATE TABLE IF NOT EXISTS `#__jem_import_profiles` (`id` int(11) unsigned NOT NULL AUTO_INCREMENT,`title` varchar(255) NOT NULL DEFAULT '',`context` varchar(50) NOT NULL DEFAULT 'events',`source_format` varchar(20) NOT NULL DEFAULT 'csv',`source_signature` varchar(64) DEFAULT NULL,`mapping` mediumtext NOT NULL,`options` mediumtext DEFAULT NULL,`published` tinyint(1) NOT NULL DEFAULT 1,`access` int(10) unsigned NOT NULL DEFAULT 1,`ordering` int(11) NOT NULL DEFAULT 0,`created` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,`created_by` int(11) unsigned NOT NULL DEFAULT 0,`modified` datetime NULL DEFAULT NULL,`modified_by` int(11) unsigned NOT NULL DEFAULT 0,PRIMARY KEY (`id`),KEY `idx_context_format` (`context`, `source_format`),KEY `idx_published` (`published`),KEY `idx_access` (`access`)) ENGINE=InnoDB;
CREATE TABLE IF NOT EXISTS `#__jem_special_days` (`id` int(11) unsigned NOT NULL AUTO_INCREMENT,`title` varchar(255) NOT NULL DEFAULT '',`alias` varchar(255) NOT NULL DEFAULT '',`day_type_id` INT(11) UNSIGNED NOT NULL DEFAULT 0,`day_type` varchar(100) NOT NULL DEFAULT '',`start_date` date DEFAULT NULL,`end_date` date DEFAULT NULL,`weekdays` varchar(30) NOT NULL DEFAULT '',`country` varchar(255) NOT NULL DEFAULT '',`region` varchar(100) NOT NULL DEFAULT '',`city` varchar(100) NOT NULL DEFAULT '',`description` text DEFAULT NULL,`article_id` INT(10) UNSIGNED NOT NULL DEFAULT 0,`url` VARCHAR(2048) NOT NULL DEFAULT '',`show_dates` tinyint(1) NOT NULL DEFAULT 1,`published` tinyint(1) NOT NULL DEFAULT 1,`access` INT(10) UNSIGNED NOT NULL DEFAULT 1,`ordering` int(11) NOT NULL DEFAULT 0,`created` datetime DEFAULT NULL,`created_by` int(11) unsigned NOT NULL DEFAULT 0,`modified` datetime DEFAULT NULL,`modified_by` int(11) unsigned NOT NULL DEFAULT 0,`checked_out` int(11) unsigned DEFAULT NULL,`checked_out_time` datetime DEFAULT NULL,PRIMARY KEY (`id`),KEY `idx_type` (`day_type`),KEY `idx_day_type_id` (`day_type_id`),KEY `idx_dates` (`start_date`,`end_date`),KEY `idx_weekdays` (`weekdays`),KEY `idx_location` (`country`,`region`,`city`),KEY `idx_published` (`published`),KEY `idx_access` (`access`),KEY `idx_article_id` (`article_id`)) ENGINE=InnoDB;
