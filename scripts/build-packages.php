...
final class JemPackageBuilder
{
    ...
    private function includeComponentEntry(string $relative): bool
    {
        ...
        if (preg_match('#^(\.git|\.settings|\.tmp[^/]*|\.phpunit\.cache|\.agents|\.claude|\.codex|\.codex-skill-staging|\.cursor|\.github/copilot|3rd|build|docs|modules|package|plugins|scripts|tests|tmp|tools|vendor|_old[^/]*|old[^/]*)(/|$)#', $relative)) {
            return false;
        }
