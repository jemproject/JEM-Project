...
final class JemPackageBuilder
{
    ...
    private function validate(string $package): void
    {
        ...
        foreach (['jem.xml', 'script.php', 'admin/jem.php', 'admin/data/currencies/country-currencies.json', 'admin/data/taxrates/eu-vat-rates.json', 'admin/classes/venuecapacity.class.php', 'admin/classes/eventpricingcapacity.class.php', 'admin/views/venue/tmpl/edit_capacity.php', 'admin/views/event/tmpl/edit_pricing.php', 'site/jem.php', 'site/classes/eventimagepath.class.php', 'site/classes/eventstructureddata.class.php', 'site/classes/venueimagepath.class.php', 'site/classes/icalcreator/autoload.php', 'media/index.html', 'media/vendor/index.html', 'admin/assets/sampledata.zip'] as $entry) {
