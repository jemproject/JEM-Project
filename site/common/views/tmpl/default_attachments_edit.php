...
<table class="adminform" id="el-attachments">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo JHtml::_('image','com_jem/publish_r.png', JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHEMENT'), array('id' => 'attach-remove'.$file->id,'class' => 'attach-remove','title'=>JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHEMENT')),true); ?></td>
		</tr>
		<?php endforeach; ?>
		<tr>
			<td>
