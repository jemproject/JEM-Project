...
require_once (JPATH_COMPONENT_SITE.'/classes/frontendcategoryaccess.class.php');
require_once (JPATH_COMPONENT_SITE.'/classes/loadmorerequestpolicy.class.php');
...
JemHelper::loadComponentLanguage($language);
