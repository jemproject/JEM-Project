...
class JemHelper
{
    ...
    /**
     * Return venues whose complete ancestry is published and viewable. Locked
     * venues may still be advertised elsewhere, but cannot grant access to a
     * programme item through a public descendant.
     */
    ...
    /**
     * Build a query condition requiring an event's complete venue ancestry to
     * be published and available to the supplied view levels.
     */
