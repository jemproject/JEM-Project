...
class JemModelMyattendances extends BaseDatabaseModel
{
    ...
    protected function _buildQueryAttending()
    {
        ...
        $query = 'SELECT DISTINCT a.id AS eventid, a.id, a.dates, a.enddates, a.times, a.endtimes, a.title, a.alias, a.created, a.locid, a.published, '
               ...
               . ' a.access, a.attribs, a.article_id, a.checked_out, a.checked_out_time, a.contactid, a.created, a.created_by, a.created_by_alias, a.custom1, a.custom2, a.custom3, a.custom4, a.custom5, a.custom6, a.custom7, a.custom8, a.custom9, a.custom10, a.datimage, a.image_path, a.featured,'
               ...
               . ' a.waitinglist, a.requestanswer, a.seriesbooking, a.singlebooking, r.id AS registration_id, r.reference AS registration_reference, r.status, r.waiting, r.comment,'
