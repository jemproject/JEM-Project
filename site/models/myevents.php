...
class JemModelMyevents extends BaseDatabaseModel
{
	...
	protected function _buildQueryEvents()
	{
		...
		$query = 'SELECT DISTINCT a.id as eventid, a.id, a.dates, a.enddates, a.published, a.times, a.endtimes, a.title, a.created, a.created_by, a.locid, a.registra, a.unregistra, a.maxplaces, a.waitinglist, a.requestanswer, a.seriesbooking, '
