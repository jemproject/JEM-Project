...
class JemModelMyevents extends BaseDatabaseModel
{
        ...
        if ($this->_events) {
            ...
            foreach ($this->_events as $i => $item) {
                ...
                if (empty($item->categories)) {
                    ...
                    $ts = JemHelper::getUtcTimestamp($item->end_utc ?? $item->start_utc ?? '');
    ...
    protected function _buildQueryEvents()
    {
        ...
        $query = 'SELECT DISTINCT a.id as eventid, a.id, a.dates, a.enddates, a.published, a.times, a.endtimes, a.timezone_mode, a.timezone, a.start_utc, a.end_utc, a.title, a.alias, a.created, a.created_by, a.locid, a.registra, a.unregistra, a.maxplaces, a.waitinglist, a.requestanswer, a.seriesbooking, a.singlebooking,'
               . ' a.recurrence_type, a.recurrence_first_id, a.series_id, a.series_order, a.recurrence_byday, a.recurrence_counter, a.recurrence_limit, a.recurrence_limit_date, a.recurrence_number, a.attribs,'
               . ' a.access, a.checked_out, a.checked_out_time, a.maxplaces, a.maxbookeduser, a.minbookeduser, a.reservedplaces, a.contactid, a.created_by_alias, a.datimage, a.image_path, a.featured,'
               ...
               . ' l.latitude, l.locdescription, l.locimage, l.image_path AS venue_image_path, l.locimage_alt, l.longitude, l.map, l.meta_description AS l_meta_description, l.meta_keywords AS l_meta_keywords, l.modified AS l_modified, l.modified_by AS l_modified_by,'
