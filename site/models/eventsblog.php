...
class JemModelEventsblog extends JemModelEventslist
{
    protected function populateState($ordering = null, $direction = null)
    {
        ...
        $period = $input->getCmd('blog_period', (string) $params->get('blog_default_period', 'all'));
        ...
        $categoryId = max(0, $input->getInt('blog_category', 0));
        $venueId    = max(0, $input->getInt('blog_venue', 0));
        $typeId     = max(0, $input->getInt('blog_type', 0));
        $country    = strtoupper(substr(preg_replace('/[^A-Z]/i', '', $input->getCmd('blog_country', '')), 0, 2));
