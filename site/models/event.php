			...
			try
			{
				...
				$query->select(
						$this->getState('item.select',
						                ...
						                'a.bookedrootevent, a.meta_keywords, a.meta_description, a.created_by_alias, a.introtext, a.fulltext, a.maxplaces, a.reservedplaces, a.minbookeduser, a.maxbookeduser, a.waitinglist, a.requestanswer, ' .
