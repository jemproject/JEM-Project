 ...
 * Raw: My Events
 */
class JemViewMyevents extends HtmlView
{
    public function display($tpl = null)
    {
        ...
        $rows = (array) $model->getEvents();
        $params = $app->getParams();
        $title = trim((string) $params->get('page_heading', $params->get('page_title', Text::_('COM_JEM_MY_EVENTS'))));

        if ($title === '') {
            $title = Text::_('COM_JEM_MY_EVENTS');
        }
        ...
        JemPdfView::renderLinkedEventList($title, $rows, 'jem-my-events.pdf');
    }
}
