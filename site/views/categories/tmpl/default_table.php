...
<div class="table-responsive">
    <table class="eventtable table table-striped" style="width:<?php echo $this->jemsettings->tablewidth; ?>;" summary="jem">
        ...
        <thead>
            <tr>
                <th id="jem_date_cat<?php echo $this->catrow->id; ?>" class="sectiontableheader" style="text-align: left;"><?php echo Text::_('COM_JEM_TABLE_DATE'); ?></th>
                <?php if ($this->jemsettings->showtitle == 1) : ?>
                <th id="jem_title_cat<?php echo $this->catrow->id; ?>" class="sectiontableheader" style="text-align: left;"><?php echo Text::_('COM_JEM_TABLE_TITLE'); ?></th>
                <?php endif; ?>
                <?php if ($this->jemsettings->showlocate == 1) : ?>
                <th id="jem_location_cat<?php echo $this->catrow->id; ?>" class="sectiontableheader" style="text-align: left;"><?php echo Text::_('COM_JEM_TABLE_LOCATION'); ?></th>
                <?php endif; ?>
                <?php if ($this->jemsettings->showcity == 1) : ?>
                <th id="jem_city_cat<?php echo $this->catrow->id; ?>" class="sectiontableheader" style="text-align: left;"><?php echo Text::_('COM_JEM_TABLE_CITY'); ?></th>
                <?php endif; ?>
                <?php if ($this->jemsettings->showstate == 1) : ?>
                <th id="jem_state_cat<?php echo $this->catrow->id; ?>" class="sectiontableheader" style="text-align: left;"><?php echo Text::_('COM_JEM_TABLE_STATE'); ?></th>
                <?php endif; ?>
                <?php if ($this->jemsettings->showcat == 1) : ?>
                <th id="jem_category_cat<?php echo $this->catrow->id; ?>" class="sectiontableheader" style="text-align: left;"><?php echo Text::_('COM_JEM_TABLE_CATEGORY'); ?></th>
                <?php endif; ?>
            </tr>
        </thead>
        ...
        <tbody>
            ...
            <?php else : ?>
                ...
                if (!$row->user_has_access_category) {
                    ...
                    <?php else : ?>
                    <tr class="sectiontableentry<?php echo ($odd + 1) . $this->params->get('pageclass_sfx') . ' event_id' . $row->id; ?>">
                    <?php endif; ?>

                        <td headers="jem_date_cat<?php echo $this->catrow->id; ?>" style="text-align: left;">
                            <?php
                        ...
                        <td headers="jem_title_cat<?php echo $this->catrow->id; ?>" style="text-align: left; vertical-align: top;">
                        ...
                        <?php if ($this->jemsettings->showlocate == 1) : ?>
                        <td headers="jem_location_cat<?php echo $this->catrow->id; ?>" style="text-align: left; vertical-align: top;">
                            <?php
                            if (!empty($row->venue)) :
                        ...
                        <?php if ($this->jemsettings->showcity == 1) : ?>
                        <td headers="jem_city_cat<?php echo $this->catrow->id; ?>" style="text-align: left; vertical-align: top;">
                            <?php echo !empty($row->city) ? $this->escape($row->city) : '-'; ?>
                        </td>
                        <?php endif; ?>

                        <?php if ($this->jemsettings->showstate == 1) : ?>
                        <td headers="jem_state_cat<?php echo $this->catrow->id; ?>" style="text-align: left; vertical-align: top;">
                            <?php echo !empty($row->state) ? $this->escape($row->state) : '-'; ?>
                        </td>
                        <?php endif; ?>

                        <?php if ($this->jemsettings->showcat == 1) : ?>
                        <td headers="jem_category_cat<?php echo $this->catrow->id; ?>" style="text-align: left; vertical-align: top;">
