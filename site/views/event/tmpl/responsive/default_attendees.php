		...
		<dd class="register registration">
			...
			if ($this->item->published != 1) {
				...
				case 2:
					...
					<input class="btn btn-secondary" type="button" value="<?php echo JText::_('COM_JEM_SIGNUPHERE_AS_GUEST'); ?>" onClick="window.location='/index.php?option=com_breezingforms&view=form&Itemid=3475&event=<?php echo $this->item->title; ?>&date=<?php echo $this->item->dates ?>&conemail=<?php echo $this->item->conemail ?>';"/>
					<?php
