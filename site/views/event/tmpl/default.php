...
$renderEventDetailImage = function ($layoutClass = '', $style = '', $useOriginalImage = false) use ($eventImageRibbonText, $eventImageRibbonClass, $detailImageField) {
    ...
    $classes = trim('jem-img jem-img-event jem-event-overview-media ' . $layoutClass);
    ...
    if ($eventImageRibbonText) {
        $html .= '<div class="jem-event-image-ribbon-wrap jem-event-image-ribbon-wrap--legacy">'
            . $image
    ...
    <div id="jem" class="event_id<?php echo $this->item->did; ?> jem_event<?php echo $this->pageclass_sfx;?>"
        ...
        <div class="venue_id<?php echo $this->item->locid; ?>" itemprop="location" itemscope="itemscope" itemtype="https://schema.org/Place">
            ...
            <?php if ($venueLayout !== 'compact') : ?>
                <h2 class="location">
                    <?php
                    echo $renderBlockHeading($eventVenueHeadingDisplay, Text::_('COM_JEM_VENUE'), $this->item->venue) ;
