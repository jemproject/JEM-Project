  ...
  <div class="jem-row">
    ...
    <div class="jem-info">
      <dl class="jem-dl">
        ...
        <dt class="jem-title" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_TITLE'); ?>"><?php echo JText::_('COM_JEM_TITLE'); ?>:</dt>
        <dd class="jem-title" itemprop="name"><?php echo $this->escape($this->item->title); ?></dd>
        <?php
        endif;
        ?>
        <dt class="jem-when" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_WHEN'); ?>"><?php echo JText::_('COM_JEM_WHEN'); ?>:</dt>
        <dd class="jem-when">
          <?php
        ...
        <dt class="jem-where" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_WHERE'); ?>"><?php echo JText::_('COM_JEM_WHERE'); ?>:</dt>
        ...
        <dt class="jem-category" data-placement="bottom" data-original-title="<?php echo $n < 2 ? JText::_('COM_JEM_CATEGORY') : JText::_('COM_JEM_CATEGORIES'); ?>">
        ...
        for ($cr = 1; $cr <= 10; $cr++) {
          ...
          if ($currentRow) {
          ?>
            <dt class="jem-custom<?php echo $cr; ?>" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_EVENT_CUSTOM_FIELD'.$cr); ?>"><?php echo JText::_('COM_JEM_EVENT_CUSTOM_FIELD'.$cr); ?>:</dt>
        ...
        <dt class="jem-hits" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_EVENT_HITS_LABEL'); ?>"><?php echo JText::_('COM_JEM_EVENT_HITS_LABEL'); ?>:</dt>
      ...
      <!-- AUTHOR -->
        ...
        <dt class="createdby" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_EVENT_CREATED_BY_LABEL'); ?>"><?php echo JText::_('COM_JEM_EVENT_CREATED_BY_LABEL'); ?>:</dt>
        <dd class="createdby">
      ...
      <!-- PUBLISHING STATE -->
        ...
        <dt class="jem-published" data-placement="bottom" data-original-title="<?php echo JText::_('JSTATUS'); ?>"><?php echo JText::_('JSTATUS'); ?>:</dt>
	...
	<dl class="jem-dl">
		<dt class="con_name" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_NAME'); ?>"><?php echo JText::_('COM_JEM_NAME'); ?>:</dt>
		<dd class="con_name">
		<?php
		...
		<dt class="con_telephone" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_TELEPHONE'); ?>"><?php echo JText::_('COM_JEM_TELEPHONE'); ?>:</dt>
    ...
    <div class="jem-row jem-wrap-reverse">    
      ...
      <dl class="jem-dl" itemprop="address" itemscope
        ...
        <dt class="venue" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_LOCATION'); ?>"><?php echo JText::_('COM_JEM_LOCATION'); ?>:</dt>
        <dd class="venue">
        ...
        <dt class="venue_street" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_STREET'); ?>"><?php echo JText::_('COM_JEM_STREET'); ?>:</dt>
        ...
        <dt class="venue_postalCode" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_ZIP'); ?>"><?php echo JText::_('COM_JEM_ZIP'); ?>:</dt>
        ...
        <dt class="venue_city" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_CITY'); ?>"><?php echo JText::_('COM_JEM_CITY'); ?>:</dt>
        ...
        <dt class="venue_state" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_STATE'); ?>"><?php echo JText::_('COM_JEM_STATE'); ?>:</dt>
        ...
        <dt class="venue_country" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_COUNTRY'); ?>"><?php echo JText::_('COM_JEM_COUNTRY'); ?>:</dt>
        ...
        <dt class="venue_published" data-placement="bottom" data-original-title="<?php echo JText::_('JSTATUS'); ?>"><?php echo JText::_('JSTATUS'); ?>:</dt>
        ...
        for ($cr = 1; $cr <= 10; $cr++) {
          ...
          if ($currentRow) {
            ?>
            <dt class="custom<?php echo $cr; ?>" data-placement="bottom" data-original-title="<?php echo JText::_('COM_JEM_VENUE_CUSTOM_FIELD'.$cr); ?>"><?php echo JText::_('COM_JEM_VENUE_CUSTOM_FIELD'.$cr); ?>:</dt>
