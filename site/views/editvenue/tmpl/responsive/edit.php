        ...
        <form action="<?php echo Route::_('index.php?option=com_jem&a_id=' . (int) $this->item->id); ?>" class="form-validate" method="post" name="adminForm" id="venue-form" enctype="multipart/form-data">
            ...
            <fieldset class="jem-editvenue-section">
                ...
                <dl class="adminformlist jem-dl">
                    ...
                    <?php if ($venueHierarchyEnabled) : ?>
                        ...
                        <dt class="visually-hidden"<?php echo $showWhenChildVenueAttribute; ?>><?php echo Text::_('COM_JEM_VENUE_TIMEZONE_INHERITED'); ?></dt>
                        <dd class="jem-venue-inherited-timezone"<?php echo $showWhenChildVenueAttribute; ?>>
            ...
            <fieldset class="jem-editvenue-section">
                ...
                <dl class="adminformlist jem-dl">
                    ...
                    <dt<?php echo $showWhenTopLevelVenueAttribute; ?>><?php echo $this->form->getLabel('timezone'); ?></dt>
                    <dd<?php echo $showWhenTopLevelVenueAttribute; ?>><?php echo $this->form->getInput('timezone'); ?></dd>
                </dl>
            </fieldset>
                ...
                <fieldset class="adminform" id="geodata">
                    ...
                    <div id="mapdiv">
                        <div class="jem-row jem-justify-start">
                            ...
                            <div><input id="find-left" class="btn btn-primary" type="button" value="<?php echo Text::_('COM_JEM_VENUE_ADDR_FINDVENUEDATA'); ?>" /></div>
                        </div>
                        ...
                        <dl class="adminformlist jem-dl">
                            ...
                            <dd><input type="text" class="inputbox" id="tmp_form_postalCode" /></dd>
                            <dt><label><?php echo Text::_('COM_JEM_CITY'); ?></label></dt>
                            <dd><input type="text" class="inputbox" id="tmp_form_city" /></dd>
                            <dt><label><?php echo Text::_('COM_JEM_STATE'); ?></label></dt>
                            <dd><input type="text" class="inputbox" id="tmp_form_state" /></dd>
                            <dt><label><?php echo Text::_('COM_JEM_VENUE'); ?></label></dt>
                            <dd><input type="text" class="inputbox" id="tmp_form_venue" /></dd>
                            <dt><label><?php echo Text::_('COM_JEM_COUNTRY'); ?></label></dt>
                            <dd><input type="text" class="inputbox" id="tmp_form_country" /></dd>
                            <dt><label><?php echo Text::_('COM_JEM_LATITUDE'); ?></label></dt>
                            <dd><input type="text" class="inputbox" id="tmp_form_latitude" /></dd>
                            <dt><label><?php echo Text::_('COM_JEM_LONGITUDE'); ?></label></dt>
                            <dd><input type="text" class="inputbox" id="tmp_form_longitude" /></dd>
                        </dl>

                        <div style="clear: both;"><br></div>
                        <div class="jem-row jem-justify-start">
                            <input id="cp-all" class="btn btn-primary" type="button" value="<?php echo Text::_('COM_JEM_VENUE_COPY_DATA'); ?>" />
                            <input id="cp-address" class="btn btn-primary" type="button" value="<?php echo Text::_('COM_JEM_VENUE_COPY_ADDRESS'); ?>" />
                            <input id="cp-venue" class="btn btn-primary" type="button" value="<?php echo Text::_('COM_JEM_VENUE_COPY_VENUE'); ?>" />
                            <input id="cp-latlong" class="btn btn-primary" type="button" value="<?php echo Text::_('COM_JEM_VENUE_COPY_COORDINATES'); ?>" />
                        </div>
                    </div>
                </fieldset>
                <p>&nbsp;</p>
