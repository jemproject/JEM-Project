				...
				<td style="width: 100%;">
					<dl class="jem-dl">
						...
						<?php //This button just deletes the dl because two times more getParent() in attachment.js is required
								?>
						<dt><?php echo JText::_('COM_JEM_ATTACHMENT_REMOVE') . ' ' . $file->name; ?></dt>
						<dd><?php echo JemOutput::removebutton(JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHEMENT'), array('id' => 'attach-remove' . $file->id . ':' . JSession::getFormToken(), 'class' => 'attach-remove btn', 'title' => JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHEMENT'))); ?></dd>
						<?php endif; ?>
						<dl>
				</td>
				<td>
