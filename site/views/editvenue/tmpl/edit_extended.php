	...
	<fieldset class="jem_fldst_image">
		...
		<ul class="adminformlist">
			<li>
				...
				<button type="button" class="button3 btn-sm btn-secondary" onclick="document.getElementById('jform_userfile').value = ''"><?php echo JText::_('JSEARCH_FILTER_CLEAR') ?></button>
				<?php
				if ($this->item->locimage) :
