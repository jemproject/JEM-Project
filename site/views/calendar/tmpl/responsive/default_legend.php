        ...
        <div class="col-md-10">
            ...
            foreach ($this->rows as $row) {
                foreach ((array) $row->categories as $cat) {
                    ...
                    ?>
                    <button class="eventCat btn btn-outline-dark me-2<?php echo $useCategoryBackground ? ' jem-calendar-legend-full' : ''; ?>" id="cat<?php echo (int) $cat->id; ?>" data-filter-class="cat<?php echo (int) $cat->id; ?>"<?php echo $categoryStyle; ?>>
                        <?php
    ...
    <div class="calendarLegends jem-row jem-justify-start row mb-4">
        ...
        <div class="col-md-10">
            ...
            foreach ($this->rows as $row) {
                ...
                ?>
                <button class="eventVenues btn btn-outline-dark me-2" id="venue<?php echo $venueId; ?>" data-filter-class="venue<?php echo $venueId; ?>">
                    <?php
                    if ($venueColor) {
