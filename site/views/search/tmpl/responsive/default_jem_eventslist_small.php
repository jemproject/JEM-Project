...
<dl class="jem-dl">
  ...
  <dd>
    <div class="jem-row jem-nowrap jem-justify-start"><?php echo Jtext::_('COM_JEM_SEARCH_FROM'); ?>&nbsp;<?php echo $this->lists['date_from'];?></div>
    <div class="jem-row jem-nowrap jem-justify-start"><?php echo Jtext::_('COM_JEM_SEARCH_TO'); ?>&nbsp;<?php echo $this->lists['date_to'];?></div>
  </dd>
  <dt>
