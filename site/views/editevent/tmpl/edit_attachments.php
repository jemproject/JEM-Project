			...
			<tr>
				...
				<td>
					<div>
						...
						<?php echo JHtml::_('select.genericlist', $this->access, 'attached-access[]', 'class="inputbox" size="7"', 'value', 'text', $file->access); ?>
					</div>
				</td>
				<td>
					<?php echo JHtml::image('media/com_jem/images/publish_r.png', JText::_('COM_JEM_REMOVE_ATTACHEMENT'), array('id' => 'attach-remove'.$file->id,'class' => 'attach-remove')); ?>
				</td>
			</tr>
			<?php endforeach; ?>
			<tr>
				...
				<td>
					<div>
						<div class="title"><?php echo JText::_('COM_JEM_ATTACHMENT_ACCESS'); ?></div>
						<?php echo JHtml::_('select.genericlist', $this->access, 'attach-access[]', 'class="inputbox" size="7"', 'value', 'text', 0); ?>
					</div>
				</td>
				<td>&nbsp;</td>
			</tr>
