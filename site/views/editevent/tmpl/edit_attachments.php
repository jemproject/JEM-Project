...
<table class="adminform" id="el-attachments">
	...
	<tbody>
		...
		<tr>
			...
			<td><?php echo JHtml::image('media/com_jem/images/publish_x.png', JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHEMENT')
			                         , array('id' => 'attach-remove'.$file->id,'class' => 'attach-remove','title'=>JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHEMENT'))); ?></td>
		</tr>
		<?php endforeach; ?>
		<tr>
			<td>
