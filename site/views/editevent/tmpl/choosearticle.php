...
if (!empty($filterBackground)) {
    $filterStyle[] = 'background-color: ' . htmlspecialchars($filterBackground, ENT_QUOTES, 'UTF-8');
}

if (!empty($filterBorder)) {
    $filterStyle[] = 'border-color: ' . htmlspecialchars($filterBorder, ENT_QUOTES, 'UTF-8');
}
?>
