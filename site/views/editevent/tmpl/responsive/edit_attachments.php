...
<fieldset>
	...
	<table class="adminform">
		<tbody>
			...
			<tr>
				<td style="width: 100%;">
          <dl class="jem-dl">
            <dt><?php echo JText::_('COM_JEM_ATTACHMENT_FILE');?></dd>
            ...
            <dt><?php echo JText::_('COM_JEM_ATTACHMENT_NAME'); ?></dt>
            ...
            <dt><?php echo JText::_('COM_JEM_ATTACHMENT_DESCRIPTION'); ?></dt>
            ...
            <?php if ($this->jemsettings->attachmentenabled != 0) : ?>  
              ...
              <dt><?php echo JText::_('COM_JEM_ATTACHMENT_REMOVE'); ?></dt>
              <dd><?php echo JemOutput::removebutton(JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHEMENT'), array('id' => 'attach-remove'.$file->id.':'.JSession::getFormToken(),'class' => 'attach-remove','title'=>JText::_('COM_JEM_GLOBAL_REMOVE_ATTACHEMENT'), 'onclick' => 'parent.abc();')); ?></dd>
            <?php endif; ?>
          <dl>
				</td>
				<td>
					<div>
						<div><?php echo JText::_('COM_JEM_ATTACHMENT_ACCESS'); ?></div>
						<?php
  ...
  <legend><?php echo JText::_('COM_JEM_ADD_USER_REGISTRATIONS').' '.JText::_('COM_JEM_ATTACHMENTS_LEGEND'); ?></legend>
  <table class="adminform" id="el-attachments">
    <tbody>   
			...
			<tr>
				<td style="width: 100%;">
          <dl class="jem-dl">
            <dt><?php echo JText::_('COM_JEM_ATTACHMENT_FILE'); ?></dt>
            <dd><input type="file" name="attach[]" class="attach-field" /></dd>
              <?php /* see attachments.js for button's onclick function */ ?>
            <dt> </dt>
            <dd><button type="button" class="clear-attach-field button3 formelm-buttons btn"><?php echo JText::_('JSEARCH_FILTER_CLEAR') ?></button></dd>
            <dt><?php echo JText::_('COM_JEM_ATTACHMENT_NAME'); ?></dt>
